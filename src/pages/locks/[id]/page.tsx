  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:py-8 text-[#1A1A2E]">
      ...
      <div className="mb-6 sm:mb-8">
        <div
          className={`border-4 border-[#1A1A2E] p-4 sm:p-6 shadow-[4px_4px_0_rgba(26,26,46,1)] ${
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div
              className={`px-3 py-1.5 sm:px-4 sm:py-2 border-4 border-[#1A1A2E] font-black uppercase text-xs sm:text-sm self-start sm:self-auto ${
                lockStatus === "withdrawn"
